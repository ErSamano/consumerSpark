...
try:
    ...
    while True:
		...
		t1 = time.time()
                ...
                dtt = datetime.now() - timedelta(minutes=5)
                dtn = datetime.now()
		...
		channelTypeId="09"
                ...
                data = ",".join(["LVDT_f17-adc"+","+str(dt)+","+str(deviceReceiptTime1)+", 49790bc3bb04,1,"+str(sourceId)+","+str(dtt)+str(amount)+","+channel+"9,"+terminalId+"366,"+transactionResponseCode+","+transactionType+","+str(dtn)+","+channelTypeId+"00-SUCCESS"])
